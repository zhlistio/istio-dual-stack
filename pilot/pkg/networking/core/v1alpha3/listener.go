				...
				for _, saddress := range saddresses {
					...
					for _, servicePort := range service.Ports {
						...
						if features.EnableHeadlessService && bind == "" && service.Resolution == model.Passthrough &&
							(saddress == constants.UnspecifiedIP || saddress == constants.UnspecifiedIPv6) &&
...
func (configgen *ConfigGeneratorImpl) buildSidecarOutboundHTTPListenerOptsForPortOrUDS(listenerMapKey *string,
	...
	*listenerMapKey = listenerOpts.bind + ":" + strconv.Itoa(listenerOpts.port.Port)
	...
	if features.EnableDualStack && net.ParseIP(actualWildcard) != nil && net.ParseIP(actualWildcard).To4() == nil && net.ParseIP(actualWildcard).To16() != nil {
...
func (configgen *ConfigGeneratorImpl) buildSidecarOutboundListenerForPortOrUDS(listenerOpts buildListenerOpts, listenerMap map[string]*outboundListenerEntry,
